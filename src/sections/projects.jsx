...
const projects = [
  {
    title: "Tales of Love and Giving",
    image:
  ...
  {
    title: "Small Acts, Big Differences",
    image:
  ...
  {
    title: "Lives Through Generosity",
    image:
  ...
  {
    title: "Sowing Seeds of Goodness",
    image:
...
const Projects = () => {
  return (
    <section className="p-[60px_20px] tablet:p-[60px_30px] bg-[#f2f2f2]">
